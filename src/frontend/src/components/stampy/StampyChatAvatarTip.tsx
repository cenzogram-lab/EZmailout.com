...
/**
 * Stampy chat avatar holding up a lightbulb card, for tips.
 *
 * Generated from `stampy-chat-avatar-tip.svg`. Clip-path and gradient ids are prefixed per
 * instance, so any number of these can share a page.
 */
export function StampyChatAvatarTip({ title, ...props }: StampyProps) {
  ...
  return (
    <svg
      ...
      data-stampy="stampy-chat-avatar-tip"
      role="img"
      aria-label={title}
    ...
    >
      ...
      <defs>
        <clipPath id={`${uid}-chat-avatar-tip-avClip3`}>
          <circle cx="32" cy="32" r="31" />
        </clipPath>
        <radialGradient
          id={`${uid}-chat-avatar-tip-tipGlow`}
          cx="0.5"
          cy="0.5"
          r="0.5"
        >
        ...
        <clipPath id={`${uid}-chat-avatar-tip-bodyClip`}>
          <path d="M124 390 C118 300 150 256 200 256 C250 256 282 300 276 390 Q200 404 124 390 Z" />
        </clipPath>
      </defs>
      <g>
        <circle cx="32" cy="32" r="31" fill="#F4F4F4" />
        <g clipPath={`url(#${uid}-chat-avatar-tip-avClip3)`}>
          <g transform="translate(-10 -2) scale(0.2)">
            <g>
              <g
                stroke="#16204A"
                strokeWidth="6"
              ...
              >
                ...
                <path
                  ...
                  fill="#9C6B38"
                  clipPath={`url(#${uid}-chat-avatar-tip-bodyClip)`}
                />
                <path
                  d="M124 390 C118 300 150 256 200 256 C250 256 282 300 276 390 Q200 404 124 390 Z"
                  fill="none"
            ...
            <circle
              ...
              cy="228"
              r="96"
              fill={`url(#${uid}-chat-avatar-tip-tipGlow)`}
            />
            <g
              stroke="#16204A"
              strokeWidth="6"
            ...
            >
              <path
                d="M252 340 C266 310 280 290 292 274 L316 284 C304 304 290 330 280 350 Z"
                fill="#FFFFFF"
              />
              <g transform="rotate(8 300 228)">
                <rect
                  x="252"
                  y="196"
                  width="96"
              ...
              <ellipse cx="302" cy="268" rx="22" ry="16" fill="#FFFFFF" />
              <path
                d="M292 256 L292 264 M304 254 L304 262 M314 256 L314 264"
                fill="none"
                strokeWidth="4"
              />
              <path
                d="M300 176 L300 158 M348 196 L364 186 M252 196 L236 186"
                fill="none"
                stroke="#F5B800"
                strokeWidth="8"
              />
