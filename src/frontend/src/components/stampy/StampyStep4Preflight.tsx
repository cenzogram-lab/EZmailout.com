...
/**
 * Stampy for Step 4 (preflight, review and pay).
 *
 * Generated from `stampy-step-4.svg`. Clip-path and gradient ids are prefixed per
 * instance, so any number of these can share a page.
 */
export function StampyStep4Preflight({ title, ...props }: StampyProps) {
  ...
  return (
    ...
    >
      ...
      <defs>
        <clipPath id={`${uid}-step-4-bodyClip`}>
      ...
      <g transform="scale(0.45)">
        ...
        >
          ...
          <rect
            ...
            strokeWidth="4"
          />
          <rect x="170" y="260" width="60" height="22" rx="6" fill="#C7CAD8" />
          <g strokeWidth="4">
            <rect
              x="144"
              y="302"
          ...
          <ellipse cx="120" cy="330" rx="18" ry="22" fill="#FFFFFF" />
          <ellipse cx="280" cy="330" rx="18" ry="22" fill="#FFFFFF" />
          <path
